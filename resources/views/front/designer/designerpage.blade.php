        ...
        <div class="row row-2-pd-30-product row-pd-btm-30">
            ...
            <div class="col-md-6">
                <div class="social text-center">
                    ...
                    <button type="submit" class="btn  Share-button text-center"> <a href="{{$user->designer->website}}"><i class="fas fa-share-alt"></i> Website</a></button>
            ...
            <div class="container text-center">
                <ul class="list-unstyed row">
                    <li data-class="all" class="active col-md"> All</li>
                        ...
                        @foreach(json_decode($user->designer->category_prof_id) as $category)
